...
// Register constants used in the compilation pipeline.
pub(crate) const ARGS_PTR_REG: u8 = 7;
pub(crate) const ARGS_LEN_REG: u8 = 8;
pub(crate) const RETURN_ADDR_REG: u8 = 0;
pub(crate) const STACK_PTR_REG: u8 = 1;
...
pub fn compile_module(module: &WasmModule) -> Result<SpiProgram> {
    ...
    for local_func_idx in 0..module.functions.len() {
        ...
        // Determine result globals for entry functions using globals convention.
