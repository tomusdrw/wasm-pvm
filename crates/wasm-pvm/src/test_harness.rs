...
impl InstructionExt for Instruction {
    fn opcode(&self) -> Option<Opcode> {
        match self {
            ...
            Instruction::BranchLtUImm { .. } => Some(Opcode::BranchLtUImm),
            Instruction::BranchLeUImm { .. } => Some(Opcode::BranchLeUImm),
            Instruction::BranchGeUImm { .. } => Some(Opcode::BranchGeUImm),
            Instruction::BranchGtUImm { .. } => Some(Opcode::BranchGtUImm),
            Instruction::BranchLtSImm { .. } => Some(Opcode::BranchLtSImm),
            Instruction::BranchLeSImm { .. } => Some(Opcode::BranchLeSImm),
            Instruction::BranchGtSImm { .. } => Some(Opcode::BranchGtSImm),
            Instruction::MoveReg { .. } => Some(Opcode::MoveReg),
            Instruction::BranchEq { .. } => Some(Opcode::BranchEq),
            Instruction::BranchNe { .. } => Some(Opcode::BranchNe),
            Instruction::BranchGeU { .. } => Some(Opcode::BranchGeU),
            Instruction::BranchLtU { .. } => Some(Opcode::BranchLtU),
            Instruction::BranchLtS { .. } => Some(Opcode::BranchLtS),
            ...
            Instruction::LoadU8 { .. } => Some(Opcode::LoadU8),
            Instruction::LoadI8 { .. } => Some(Opcode::LoadI8),
            Instruction::LoadU16 { .. } => Some(Opcode::LoadU16),
            Instruction::LoadI16 { .. } => Some(Opcode::LoadI16),
            Instruction::LoadU32 { .. } => Some(Opcode::LoadU32),
            Instruction::LoadI32 { .. } => Some(Opcode::LoadI32),
            Instruction::LoadU64 { .. } => Some(Opcode::LoadU64),
            Instruction::StoreU8 { .. } => Some(Opcode::StoreU8),
            Instruction::StoreU16 { .. } => Some(Opcode::StoreU16),
            Instruction::StoreU32 { .. } => Some(Opcode::StoreU32),
            Instruction::StoreU64 { .. } => Some(Opcode::StoreU64),
            Instruction::LoadIndI32 { .. } => Some(Opcode::LoadIndI32),
            Instruction::ReverseBytes { .. } => Some(Opcode::ReverseBytes),
            Instruction::ShloLImmAlt32 { .. } => Some(Opcode::ShloLImmAlt32),
            Instruction::ShloRImmAlt32 { .. } => Some(Opcode::ShloRImmAlt32),
            Instruction::SharRImmAlt32 { .. } => Some(Opcode::SharRImmAlt32),
            Instruction::ShloLImmAlt64 { .. } => Some(Opcode::ShloLImmAlt64),
            Instruction::ShloRImmAlt64 { .. } => Some(Opcode::ShloRImmAlt64),
            Instruction::SharRImmAlt64 { .. } => Some(Opcode::SharRImmAlt64),
            Instruction::RotRImm64 { .. } => Some(Opcode::RotRImm64),
            Instruction::RotRImmAlt64 { .. } => Some(Opcode::RotRImmAlt64),
            Instruction::RotRImm32 { .. } => Some(Opcode::RotRImm32),
            Instruction::RotRImmAlt32 { .. } => Some(Opcode::RotRImmAlt32),
            Instruction::LoadImmJumpInd { .. } => Some(Opcode::LoadImmJumpInd),
            Instruction::MulUpperSS { .. } => Some(Opcode::MulUpperSS),
            Instruction::MulUpperUU { .. } => Some(Opcode::MulUpperUU),
            Instruction::MulUpperSU { .. } => Some(Opcode::MulUpperSU),
            Instruction::RotL64 { .. } => Some(Opcode::RotL64),
            Instruction::RotL32 { .. } => Some(Opcode::RotL32),
            Instruction::RotR64 { .. } => Some(Opcode::RotR64),
            Instruction::RotR32 { .. } => Some(Opcode::RotR32),
            Instruction::AndInv { .. } => Some(Opcode::AndInv),
            Instruction::OrInv { .. } => Some(Opcode::OrInv),
            Instruction::Xnor { .. } => Some(Opcode::Xnor),
            Instruction::Max { .. } => Some(Opcode::Max),
            Instruction::MaxU { .. } => Some(Opcode::MaxU),
            Instruction::Min { .. } => Some(Opcode::Min),
            Instruction::MinU { .. } => Some(Opcode::MinU),
