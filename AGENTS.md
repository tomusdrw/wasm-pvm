...
- **Peephole shift-pair cleanup**: `peephole.rs` removes redundant `ShloL64+ShloR64` i32-zext pairs when they immediately follow compatible 32-bit producers (or `Load{Ind}U32`) and are not label targets.
